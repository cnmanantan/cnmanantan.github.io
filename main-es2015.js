...
let HeadingTextDirective = class HeadingTextDirective {
    constructor(el) {
        this.el = el;
...
HeadingTextDirective.ctorParameters = () => [
...
let HeadingWrapperDirective = class HeadingWrapperDirective {
    constructor(el) {
        this.el = el;
...
HeadingWrapperDirective.ctorParameters = () => [
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"] }
];
...
let HighlightTextDirective = class HighlightTextDirective {
    constructor(el) {
        this.el = el;
...
HighlightTextDirective.ctorParameters = () => [
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"] }
];
...
let DirectivesPageModule = class DirectivesPageModule {
};
...
class ApiService {
    ...
    getData() {
        return this.http.get(this.endpointURL)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(model => model.data));
    }
}
